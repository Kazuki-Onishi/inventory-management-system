...
const Sidebar: React.FC = () => {
  ...
  const navItems: Array<{
    ...
    { to: '/vendors', label: t('nav.vendors'), icon: ICONS.vendors, minRole: Role.Editor },
    { to: '/vendors/assignments', label: t('nav.vendorAssignments'), icon: ICONS.vendorAssignments, minRole: Role.Editor },
